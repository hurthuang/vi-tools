...
const G2_ALWAYS = {'and':'⠯','ar':'⠜','betws':'⠃⠑⠞⠺⠎','cannot':'⠸⠉','cch':'⠉⠡','ch':'⠡','character':'⠐⠡','day':'⠐⠙','ear':'⠑⠜','ed':'⠫','eever':'⠑⠑⠧⠻','encephal':'⠢⠉⠑⠏⠓⠁⠇','er':'⠻','ever':'⠐⠑','eversion':'⠑⠧⠻⠨⠝','evertebra':'⠑⠧⠻⠞⠑⠃⠗⠁','evertib':'⠑⠧⠻⠞⠊⠃','father':'⠐⠋','ffor':'⠋⠿','for':'⠿','gh':'⠣','had':'⠸⠓','here':'⠐⠓','hered':'⠓⠻⠫','herence':'⠓⠻⠰⠑','herencies':'⠓⠻⠢⠉⠊⠑⠎','herency':'⠓⠻⠢⠉⠽','herend':'⠓⠻⠢⠙','herent':'⠓⠻⠢⠞','herer':'⠓⠻⠻','honest':'⠓⠐⠕⠌','iever':'⠊⠑⠧⠻','know':'⠐⠅','lord':'⠐⠇','many':'⠸⠍','mention':'⠍⠢⠰⠝','monetary':'⠍⠐⠕⠞⠜⠽','mother':'⠐⠍','name':'⠐⠝','nament':'⠝⠁⠰⠞','of':'⠷','ofor':'⠕⠿','one':'⠐⠕','ou':'⠳','ought':'⠐⠳','ow':'⠪','owork':'⠕⠐⠺','part':'⠐⠏','phad':'⠏⠓⠁⠙','pineapple':'⠏⠔⠑⠁⠏⠏⠇⠑','question':'⠐⠟','reverb':'⠗⠑⠧⠻⠃','reversab':'⠗⠑⠧⠻⠎⠁⠃','reversib':'⠗⠑⠧⠻⠎⠊⠃','reversif':'⠗⠑⠧⠻⠎⠊⠋','right':'⠐⠗','severed':'⠎⠐⠑⠫','sh':'⠩','some':'⠐⠎','somever':'⠎⠕⠍⠐⠑','spirit':'⠸⠎','st':'⠌','th':'⠹','the':'⠮','their':'⠸⠮','these':'⠘⠮','through':'⠐⠹','time':'⠐⠞','timent':'⠞⠊⠰⠞','under':'⠐⠥','upon':'⠘⠥','vinedress':'⠧⠔⠑⠙⠗⠑⠎⠎','wh':'⠱','where':'⠐⠱','whose':'⠘⠱','with':'⠾','word':'⠘⠺','work':'⠐⠺','world':'⠸⠺','young':'⠐⠽','there':'⠐⠮','those':'⠘⠹'};
